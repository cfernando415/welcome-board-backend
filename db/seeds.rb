...
# Post.create!({content: "test content", mod_id: Mod.find_by(rank: 1).id, user_id: 1})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 2).id, user_id: 2})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 2).id, user_id: 2})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 3).id, user_id: 1})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 3).id, user_id: 2})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 3).id, user_id: 3})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 4).id, user_id: 2})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 4).id, user_id: 1})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 4).id, user_id: 3})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 4).id, user_id: 1})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 4).id, user_id: 2})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 4).id, user_id: 1})
# Post.create({content: "test content", mod_id: Mod.find_by(rank: 4).id, user_id: 3})
